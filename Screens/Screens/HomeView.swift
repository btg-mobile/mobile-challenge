...
class HomeView: UIView, Drawable {
    ...
    private weak var otherCurrenciesTableView: UITableView!
    private weak var statusBarBackground: UIView!
    private weak var bottomBackground: UIView!
    var otherCurrencies = [Model.OtherCurrency]() { didSet { otherCurrenciesTableView.reloadData() }}
    ...
    func stylizeViews() {
        statusBarBackground.backgroundColor = #colorLiteral(red: 0.2119999975, green: 0.2630000114, blue: 0.3330000043, alpha: 1)
        ...
        otherCurrenciesTableView.backgroundColor = #colorLiteral(red: 0.2820000052, green: 0.3219999969, blue: 0.3840000033, alpha: 1)
    }
...
extension HomeView: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.currenciesPair.text = currency.currenciesPair
        cell.lastSeen.text = currency.lastSeen
...
fileprivate class Cell: UITableViewCell, Drawable {
    ...
    private(set) weak var amount: UILabel!
    private(set) weak var currenciesPair: UILabel!
    private(set) weak var lastSeen: UILabel!
    private(set) weak var bottomLine: UIView!
...
fileprivate class Header: UITableViewHeaderFooterView, Drawable {
    ...
    private class SelectedCurrencyPair: UIView, Drawable {
        ...
        func createViewsHierarchy() {
            ...
            lastUpdate.text = "Updated 2 hours ago"
