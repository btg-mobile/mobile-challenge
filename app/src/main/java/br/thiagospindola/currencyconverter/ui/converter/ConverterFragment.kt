package br.thiagospindola.currencyconverter.ui.converter
...
import br.thiagospindola.currencyconverter.databinding.FragmentConverterBinding
import br.thiagospindola.currencyconverter.viewmodels.ConverterViewModel
import kotlinx.android.synthetic.main.fragment_converter.*

class ConverterFragment : Fragment() {

    private val viewModel by lazy {
        ViewModelProvider(activity!!).get(ConverterViewModel::class.java)
    }
