...
/**
 * @brief Container for holding all buttons in group.
 */
- (NSArray<RadioButton *> *)allButtons;
...
/**
 * @brief Color of background icon, default is title color for current UIControlState.
 */
